!function (e) {
    ...
    function i(e = []) {
        ...
        return 3 !== a.length || 3 !== n.length ? (o.warn('enableArea() 参数格式为: ["2018-2-1", "2018-3-1"]'), {}) : {
            start: a,
            end: n,
    ...
    class f extends n.default {
        ...
        setSelectedDays(e) {
            if (!(0, o.default)(this.Component).getCalendarConfig().multi) return l.warn("单选模式下不能设置多日期选中，请配置 multi");
        ...
        __judgeParam(e) {
            ...
            return t[2] > r || t[2] < 1 ? (l.warn("enableArea() 开始日期错误，指定日期不在当前月份天数范围内"), !1) : t[1] > 12 || t[1] < 1 ? (l.warn("enableArea() 开始日期错误，月份超出1-12月份"), !1) : a[2] > c || a[2] < 1 ? (l.warn("enableArea() 截止日期错误，指定日期不在当前月份天数范围内"), !1) : a[1] > 12 || a[1] < 1 ? (l.warn("enableArea() 截止日期错误，月份超出1-12月份"), !1) : !(n > o) || (l.warn("enableArea()参数最小日期大于了最大日期"), !1)
        }
    ...
    function Z(e, t) {
        d.initialTasks.flag = "process", (b = e).config = t, function (e) {
            let t = ["日", "一", "二", "三", "四", "五", "六"];
            "Mon" === e && (t = ["一", "二", "三", "四", "五", "六", "日"]), p({"calendar.weeksCh": t})
